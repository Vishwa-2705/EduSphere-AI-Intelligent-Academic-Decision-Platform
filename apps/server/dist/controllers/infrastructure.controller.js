...
exports.createMaintenanceTicket = exports.getMaintenanceTickets = exports.getInfrastructureStatus = void 0;
const Infrastructure_1 = require("../models/Infrastructure");
const getInfrastructureStatus = async (_req, res, next) => {
    try {
        const devices = await Infrastructure_1.InfrastructureDevice.find();
        ...
        const waterAvg = waterDevices.length > 0
            ...
            : 100.0;
        const openTicketsCount = await Infrastructure_1.MaintenanceTicket.countDocuments({ status: { $ne: 'RESOLVED' } });
        res.status(200).json({
            success: true,
            data: {
                telemetry: {
...
const getMaintenanceTickets = async (_req, res, next) => {
    try {
        const tickets = await Infrastructure_1.MaintenanceTicket.find()
...
exports.getMaintenanceTickets = getMaintenanceTickets;
const createMaintenanceTicket = async (req, res, next) => {
    try {
        ...
        const ticket = await Infrastructure_1.MaintenanceTicket.create({
