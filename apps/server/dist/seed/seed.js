...
const Infrastructure_1 = require("../models/Infrastructure");
const seedDatabase = async (disconnectAfter = true) => {
    try {
        ...
        await Promise.all([
            ...
            Timetable_1.TimetableSlot.deleteMany({}),
            StudyMaterial_1.StudyMaterial.deleteMany({}),
            Fee_1.FeeInvoice.deleteMany({}),
            Admission_1.AdmissionApplication.deleteMany({}),
            Hostel_1.HostelRoom.deleteMany({}),
            Hostel_1.HostelAllocation.deleteMany({}),
            Infrastructure_1.InfrastructureDevice.deleteMany({}),
            Infrastructure_1.MaintenanceTicket.deleteMany({}),
        ]);
        ...
        const mechDept = await Department_1.Department.create({
            code: 'MECH',
        ...
        const priyaHOD = await User_1.User.create({
        ...
        const arunFaculty = await User_1.User.create({
        ...
        const rohitFaculty = await User_1.User.create({
        ...
        const itHOD = await User_1.User.create({
        ...
        const wardenUser = await User_1.User.create({
        ...
        const student4 = await User_1.User.create({
        ...
        for (const day of days) {
            for (const slot of slotConfigs) {
                await Timetable_1.TimetableSlot.create({
                    department: cseDept._id,
                    course: slot.course,
        ...
        await StudyMaterial_1.StudyMaterial.create([
            {
                course: course1._id,
        ...
        const exam1 = await Exam_1.Exam.create({
            course: course1._id,
            examType: 'MID_TERM',
        ...
        const exam2 = await Exam_1.Exam.create({
            course: course2._id,
            examType: 'MID_TERM',
        ...
        const exam3 = await Exam_1.Exam.create({
            course: course3._id,
            examType: 'MID_TERM',
        ...
        // Grade Entries
        await Exam_1.GradeEntry.create([
            {
                exam: exam1._id,
                course: course1._id,
                student: studentUser._id,
        ...
        const session1 = await Attendance_1.AttendanceSession.create({
            course: course1._id,
            faculty: facultyUser._id,
            date: new Date(),
        ...
        await Admission_1.AdmissionApplication.create([
            {
        ...
        const block4Room = await Hostel_1.HostelRoom.create({
        ...
        await Hostel_1.HostelRoom.create([
        ...
        await Hostel_1.HostelAllocation.create({
            student: studentUser._id,
            room: block4Room._id,
        ...
        await Infrastructure_1.InfrastructureDevice.create([
        ...
        await Infrastructure_1.MaintenanceTicket.create([
            {
